...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		['Breezy',		'iconbreezy',		'Programming',					'https://twitter.com/BreezyMelee',	'0xFF6E56A0'],
		['Murasaki',		'iconMURA',		'Programming',					'https://twitter.com/Murasaki_1514',	'0xFFFF5573'],
		['Jorge - Sun Spirit',		'SauseIcon',		'Programming',					'https://twitter.com/Jorge_SunSpirit',	'0xFFDB8B2E'],
		['Degen Dan',		'dan',		'Charting for songs',					'https://www.youtube.com/c/DegenDan/videos',	'0xFF71F6FF'],
		['Vivii',		'iconvivii',		'Charting for songs',					'https://twitter.com/Glitchy2260',	'0xFF5CB847'],
		['HPK',		'iconkeyz',		'Music Videos used for release',					'https://twitter.com/HighPoweredArt',	'0xFFFF002F'],
		[''],
